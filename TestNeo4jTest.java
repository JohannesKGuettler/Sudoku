...
class TestNeo4jTest {
	...
	void testCreatePlayResult() {
		...
		greeter.createPlayResult("test", 99, "010101");
	...
	void testGetDailySudoku() {
		...
		for (int i=0; i<9; i++) {
			...
			System.out.println(Arrays.toString(downloadedDailySudoku[i]));
		}
		// this sudoku should look like the following
		// row1: [0, 1, 0, 4, 3, 0, 6, 7, 0]
		// row2: [0, 3, 0, 0, 0, 0, 0, 0, 0]
		// row3: [5, 0, 0, 9, 0, 0, 0, 0, 2]
		// row4: [3, 5, 0, 1, 8, 0, 0, 0, 0]
		// row5: [0, 6, 0, 0, 0, 0, 2, 0, 0]
		// row6: [0, 0, 0, 0, 0, 0, 8, 3, 7]
		// row7: [0, 2, 0, 0, 0, 7, 0, 0, 3]
		// row8: [0, 0, 0, 8, 0, 3, 1, 2, 0]
		// row9: [6, 0, 0, 2, 0, 0, 0, 0, 5]
		greeter.close();
	}
