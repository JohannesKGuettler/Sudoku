...
public class Generator {
	...
	/**
	 * getter method to access difficulty of sudoku (only used for testing)
	...
	/**
	 * getter method to access numSol of sudoku (only used for testing)
	 * @return: integer that represents number of found Solutions (2 includes two or more) of sudoku
	 */
	...
	/**
	 * method to reset numSol of sudoku (only used for testing)
	 */
	public void resetNumSol() {
		this.numSol = 0;
	}
}